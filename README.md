...
<p align="center">
  <img width="70%" alt="High-level architecture diagram of the selfie web app, showing camera and local image processing, speech services, simple guidance mode, voice control mode, backend LLM/VLM proxies with Redis key validation, and external providers (OpenRouter/Gemini and a self-hosted VLM API)." src="https://github.com/user-attachments/assets/d33c0627-a2af-4500-bc63-bf265a7bab63" />
</p>
